...
def prepare_datasets(source_class, target_class):
    if DATASET == 'CIFAR10':
        trainset = torchvision.datasets.CIFAR10(
            root='~/envs/pytorch-cuda/mavisbai', train=True, download=True, transform=torchvision.transforms.ToTensor(),
        )
        testset = torchvision.datasets.CIFAR10(
            root='~/envs/pytorch-cuda/mavisbai', train=False, download=True, transform=torchvision.transforms.ToTensor(),
        )
        class_number = 10
    elif DATASET == 'GTSRB':
        ...
        trainset = torchvision.datasets.DatasetFolder(
            root='~/envs/pytorch-cuda/mavisbai/GTSRB/train', # please replace this with path to your training set
            loader=cv2.imread,
            extensions=('png',),
        ...
        testset = torchvision.datasets.DatasetFolder(
            root='~/envs/pytorch-cuda/mavisbai/GTSRB/testset', # please replace this with path to your test set
            loader=cv2.imread,
            extensions=('png',),
        ...
        data_dir = '~/envs/pytorch-cuda/mavisbai/sub-imagenet-200'
...
ckpt_dir = '~/envs/pytorch-cuda/mavisbai/pretrain/ResNet18_{}.pth'.format(DATASET)
if os.path.exists(ckpt_dir):
    ...
    if DATASET == 'ImageNet' or DATASET == 'TinyImageNet':
        ckpt_dir_ = '~/envs/pytorch-cuda/mavisbai/pretrain/ResNet18_ImageNet_Download.pth'
...
ckpt_dir_ = '~/envs/pytorch-cuda/mavisbai/unsa/ResNet18_{}_dis_{}_{}_{}_{}_{}_{}.pth'.format(DATASET, BETA, POISON_NUM, PATCH_SIZE, CLASS_NUM, SOURCE_CLASS, TARGET_CLASS)
