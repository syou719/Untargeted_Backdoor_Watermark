...
ckpt_dir = './pretrain/ResNet18_{}.pth'.format(DATASET)
...
ckpt_dir_ = './unsa/ResNet18_{}_dis_{}_{}_{}_{}_{}_{}.pth'.format(DATASET, BETA, POISON_NUM, PATCH_SIZE, CLASS_NUM, SOURCE_CLASS, TARGET_CLASS)
